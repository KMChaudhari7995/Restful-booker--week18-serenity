...
public class CRUDTest extends TestBase {
    ...
    static String firstname = "Khushi" + TestUtils.getRandomValue();
    static String lastname = "Chaudhari";
    static int totalprice = 500;
    static boolean depositpaid = true;
    static String additionalneeds = "Breakfast";
    static String checkin = "2023-07-09";
    static String checkout = "2023-07-11";
